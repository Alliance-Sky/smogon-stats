...
- **Noise Reduction**: Automatically filters out Pokémon and detailed stats (moves, items, spreads, abilities) that have exactly `0.00000%` usage to provide a cleaner viewing experience while still including Pokémon with `<0.01%` usage.
